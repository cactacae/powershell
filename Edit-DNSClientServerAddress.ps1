...
#
# Example:
# ./Edit-DNSClientServerAddress.ps1 "10.10.10.20" "10.10.20.20"
...
# invoke-command btmgmt9 -ScriptPath .\Edit-DNSClientServerAddress.ps1  -ArgumentList "10.10.20.10","10.10.20.20"
